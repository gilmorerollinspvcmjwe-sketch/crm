...
- 正在做什么：按 Impeccable 标准检查前端 UI 质量与设计一致性
- 上次停在哪：项目已有大量页面和组件，但缺少统一的高阶设计上下文
- 近期关键决定：新增 `.impeccable.md`，明确面向海外 B 端企业用户，设计方向为专业、大气、先进，参考 Zoho / HubSpot，避免 Ant Design 模板感
