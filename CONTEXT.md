...
- 正在做什么：继续把自定义对象平台向桌面文档对齐，已把对象设置页接成配置中枢，并把表单/页面/视图/关系/阶段五个工具页统一到工作区风格
- 上次停在哪：自定义对象的打开和基础工作区风格已经修好，但对象配置流还分散在多个工具页里，缺少统一入口和一致表达
- 近期关键决定：先从对象设置页把“自定义属性 / 编辑表单 / 对象关系 / 阶段管理 / 自定义页面 / 视图管理”串起来，再逐页升级这些工具页内部体验
