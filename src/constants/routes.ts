...
export const CUSTOM_OBJECTS = {
  ...
  FORM_DESIGNER: '/custom-objects/:objectId/form-designer',
  PAGE_BUILDER: '/custom-objects/:objectId/page-builder',
  VIEW_MANAGER: '/custom-objects/:objectId/view-manager',
  PIPELINE_MANAGER: '/custom-objects/:objectId/pipeline-manager',
  OBJECT_RELATIONSHIPS: '/custom-objects/:objectId/object-relationships',
