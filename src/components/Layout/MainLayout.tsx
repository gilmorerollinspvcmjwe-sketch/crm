            ...
            return (
              ...
              >
                <span className="min-w-0">
                  ...
                  <span className="mt-0.5 block truncate text-[11px] text-white/45">{child.description}</span>
                </span>
              </button>
            )
          })}
    ...
    <div className="flex h-full flex-col bg-[oklch(var(--shell-nav))] text-[oklch(var(--shell-nav-foreground))]">
        ...
        <div className={cn('flex items-center gap-3', collapsed && 'justify-center')}>
          ...
          {!collapsed && (
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs text-white/50">Industrial shell for sales and operations</p>
            </div>
          )}
        </div>
        {!collapsed && (
      ...
      <div className="border-t border-[oklch(var(--shell-nav-border))] px-3 py-4">
        {collapsed ? (
          ...
          <div className="rounded-2xl border border-white/6 bg-white/4 px-3.5 py-3">
            <div className="flex items-center justify-between gap-3">
              <div>
                <p className="text-sm font-medium">Shell compact mode</p>
                <p className="mt-1 text-xs leading-5 text-white/48">压缩侧栏后保留更大的数据工作区</p>
              </div>
              <Button
                variant="ghost"
                size="icon"
                aria-label="折叠侧边栏"
                className="h-10 w-10 rounded-xl text-white/65 hover:bg-white/6 hover:text-white"
                onClick={toggleSidebar}
              >
                <PanelLeftClose className="h-4 w-4" />
              </Button>
