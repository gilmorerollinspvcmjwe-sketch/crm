        ...
        {!previewMode && (
          <div className="w-56 border-r bg-sidebar flex flex-col">
            <div className="px-4 py-3">
              ...
              <Input placeholder="搜索字段..." className="h-8 text-xs" />
            </div>
            <Separator />
                    ...
                    <div key={field.id} className="space-y-1">
                      <div
                        className={cn(
                          ...
                          assignedFieldIds.has(field.id) && "opacity-50"
                        )}
                        onClick={() => {
                          if (selectedSection && !assignedFieldIds.has(field.id)) {
