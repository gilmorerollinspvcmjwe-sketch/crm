    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { key: '/settings/form-designer', label: '表单设计器', description: '可视化配置表单布局和字段' },
          { key: '/settings/page-builder', label: '页面设计器', description: '管理页面结构和区块布局' },
          { key: '/settings/view-manager', label: '视图管理', description: '维护列表和筛选视图配置' },
          { key: '/settings/pipeline-manager', label: '管道管理', description: '管理销售阶段和流程结构' },
          { key: '/settings/object-relationships', label: '对象关系', description: '配置对象之间的引用关系' },
