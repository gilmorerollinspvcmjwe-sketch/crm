...
- 正在做什么：继续推进主工作流页面升级，列表工作台模板已复制到核心列表页，CustomerDetail 已加入 AI 洞察 tab 并开始朝 360 动态客户档案收敛
- 上次停在哪：列表模板层基本成形，但 CustomerDetail 还缺更深一层的信息重排和设置/自定义对象内部页面风格升级
- 近期关键决定：优先保持业务字段、按钮和区块完整，再在此基础上增强 CustomerDetail 的 360 全景、AI 中间区和经营主线表达
